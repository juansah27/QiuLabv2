...
import {
  createSlot
} from "./chunk-RLIBC4G2.js";
import {
  useControllableState,
  useId,
  usePrevious,
  useSize
} from "./chunk-IMYCABOT.js";
import {
  ...
  useDirection,
  useLayoutEffect2
} from "./chunk-QXG2U3CE.js";
import {
  useComposedRefs
} from "./chunk-HO5VDDD4.js";
import {
  require_react_dom
...
var SelectContent = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    if (!context.open) {
      const frag = fragment;
      return frag ? ReactDOM7.createPortal(
...
var SelectItemText = React25.forwardRef(
  (props, forwardedRef) => {
    ...
    return (0, import_jsx_runtime13.jsxs)(import_jsx_runtime13.Fragment, { children: [
      ...
      itemContext.isSelected && context.valueNode && !context.valueNodeHasChildren ? ReactDOM7.createPortal(itemTextProps.children, context.valueNode) : null
    ] });
  }
);
